        ...
        <div className="admin-page space-y-6">
            ...
            <div id="bot-auto" className="glass-panel p-6 rounded-2xl border border-slate-200 space-y-5 shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="space-y-1">
                        <div className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5">Aktif saatler (UTC)</div>
                        <input
            ...
            <div className="glass-panel p-6 rounded-2xl border border-slate-200 space-y-5 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <div className="space-y-1">
                        <div className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5">Kadın yuzdesi</div>
                        <input
                            type="number"
            ...
            <div id="name-pool" className="glass-panel p-6 rounded-2xl border border-slate-200 space-y-5 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="space-y-1">
                        <div className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5">Kadın isimleri (her satir bir isim)</div>
                        <textarea
                            value={nameFemale}
