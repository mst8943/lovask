        ...
        <div className="space-y-6">
            <div className="flex items-end justify-between">
                ...
                <div className="flex items-center gap-2">
                    <button onClick={() => setFilter('low')} className={`text-xs px-3 py-1 rounded-full border ${filter === 'low' ? 'bg-rose-50 text-rose-800 border-rose-200' : 'bg-white/10 text-gray-300 border-white/10'}`}>
                        Düşük
                    </button>
                    <button onClick={() => setFilter('all')} className={`text-xs px-3 py-1 rounded-full border ${filter === 'all' ? 'bg-rose-50 text-rose-800 border-rose-200' : 'bg-white/10 text-gray-300 border-white/10'}`}>
                        Tümü
                    </button>
