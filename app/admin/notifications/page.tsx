                    ...
                    <div className="divide-y divide-white/5">
                        {rows.map((n) => {
                            ...
                            const title = typeof (payload as { title?: unknown }).title === 'string'
                                ...
                                : String(n.type || '')
                            const body = (() => {
                                const maybeBody = (payload as { body?: unknown }).body
                                if (typeof maybeBody === 'string') return maybeBody
                                const maybeSubject = (payload as { subject?: unknown }).subject
                                return typeof maybeSubject === 'string' ? maybeSubject : ''
                            })()
                            return (
