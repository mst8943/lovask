        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                ...
                <div className="glass-panel p-4 rounded-2xl">
                    ...
                    <div className="text-xl font-semibold text-emerald-700">{filteredRows.filter((r) => r.is_verified).length}</div>
                </div>
            </div>
            {selectedIds.length > 0 && (
                <div className="glass-panel p-4 rounded-2xl flex flex-wrap items-center gap-3 text-xs">
                    ...
                    <button
                        ...
                        className="px-3 py-1 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-700 flex items-center gap-1"
                    >
                    ...
                    <button
                        ...
                        className="px-3 py-1 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-700"
                    >
                        Ban kaldır
                    </button>
                    <button
