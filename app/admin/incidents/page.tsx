        ...
        <div className="admin-page space-y-6">
            <div className="flex items-end justify-between">
                <div>
                    ...
                    <p className="text-sm text-slate-700">Olay yönetimi ve timeline</p>
                </div>
                    ...
                    <div key={row.id} className="glass-panel p-4 rounded-2xl space-y-2">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <div className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5">{row.severity} · {row.status}</div>
                            </div>
