        ...
        <div className="space-y-6">
            <div className="flex items-end justify-between">
                <div>
                    ...
                    <p className="text-sm text-slate-500">Token ve maliyet raporu</p>
                </div>
            ...
            <div className="space-y-3">
                {rows
                    ...
                    .map((r) => (
                    <div key={r.id} className="glass-panel p-4 rounded-2xl text-sm border border-slate-200">
                ...
                {rows.length === 0 && (
                    <div className="text-sm text-slate-500">AI kullanımı yok.</div>
                )}
            </div>
        </div>
    )
