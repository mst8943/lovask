        ...
        <div className="admin-page space-y-6">
            <div className="flex items-end justify-between">
                <div>
                    ...
                    <p className="text-sm text-slate-700">Aşırı aktivite / harcama görünümü</p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                <div className="glass-panel p-4 rounded-2xl">
                    ...
                    {topLikes.length === 0 ? (
                        <div className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5">Veri yok</div>
                    ) : (
