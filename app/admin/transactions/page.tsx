        ...
        <div className="admin-page space-y-6">
            <div className="flex items-end justify-between">
                <div>
                    ...
                    <p className="text-sm text-slate-700">Jeton ve odeme hareketleri</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-3">
                <div className="glass-panel p-4 rounded-2xl">
                    <div className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5">Toplam kayıt</div>
                    <div className="text-xl font-semibold">{filtered.length}</div>
                </div>
                <div className="glass-panel p-4 rounded-2xl">
                    <div className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5">Toplam gelir</div>
                    <div className="text-xl font-semibold text-emerald-700">
                        +{new Intl.NumberFormat('tr-TR').format(totalIn)}
                    </div>
                </div>
                <div className="glass-panel p-4 rounded-2xl">
                    <div className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5">Toplam gider</div>
                    <div className="text-xl font-semibold text-rose-300">
                        {new Intl.NumberFormat('tr-TR').format(totalOut)}
                    </div>
                </div>
                <div className="glass-panel p-4 rounded-2xl">
                    <div className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5">Net</div>
                    <div className={`text-xl font-semibold ${net >= 0 ? 'text-emerald-700' : 'text-rose-300'}`}>
                        {new Intl.NumberFormat('tr-TR').format(net)}
                    </div>
                </div>
                <div className="glass-panel p-4 rounded-2xl">
                    <div className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5">Ortalama</div>
                    <div className="text-xl font-semibold">
                        {new Intl.NumberFormat('tr-TR').format(Math.round(avgAmount))}
                    </div>
                </div>
                <div className="glass-panel p-4 rounded-2xl">
                    <div className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5">Max Islem</div>
                    <div className="text-xl font-semibold">
            ...
            {filtered.length === 0 && (
                <div className="text-sm text-slate-700">Islem yok.</div>
            )}
        </div>
    )
}