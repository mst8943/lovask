        ...
        <div className="admin-page space-y-6">
            <div className="flex items-end justify-between">
                <div>
                    ...
                    <p className="text-sm text-slate-700">Tüm kuyrukları tek ekranda yönet.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                {(['support', 'report', 'verification', 'payment'] as const).map((key) => (
                    ...
                    >
                        <div>
                            <div className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5">{queueConfig[key].label}</div>
            ...
            <div className="glass-panel p-4 rounded-2xl">
                ...
                {activity.length === 0 ? (
                    <div className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5">Kayıt yok.</div>
                ) : (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="glass-panel p-4 rounded-2xl">
                    ...
                    <div className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5">P0 + P1 işler</div>
                </div>
                <div className="glass-panel p-4 rounded-2xl">
                    <div className="flex items-center gap-2 text-xs text-slate-500">
                        <ShieldAlert size={12} />
                    ...
                    <div className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5">P0 işler</div>
                </div>
                <div className="glass-panel p-4 rounded-2xl">
                    <div className="flex items-center gap-2 text-xs text-slate-500">
                        <Activity size={12} />
                    ...
                    <div className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5">Aktif kuyruk toplamı</div>
                </div>
            </div>
        </div>
    )
