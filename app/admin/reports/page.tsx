...
type ReportRow = {
    ...
    status: 'pending' | 'resolved' | 'dismissed' | string | null
    reason?: string | null
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-2 text-xs">
                ...
                <button
                    ...
                    className="px-3 py-2 rounded-lg border border-emerald-200 bg-emerald-50 text-emerald-800 disabled:opacity-40"
                >
                    Toplu çöz
                </button>
                <button
                    ...
                    <div key={r.id} className="glass-panel p-4 rounded-2xl space-y-2 border border-white/10">
                        ...
                        <div className="flex items-center gap-2 pt-2">
                            {r.status === 'pending' && (
                                <>
                                    <button
                                        onClick={() => handleResolve(r.id, 'resolved', r.reported_id || undefined)}
                                    ...
                                    <button
                                        onClick={() => handleResolve(r.id, 'dismissed', r.reported_id || undefined)}
                                        disabled={actionId === r.id}
                                    ...
                                    <button
                                        onClick={() => {
                                            ...
                                            void handleBan(r.reported_id, r.id)
                                        }}
                                        disabled={actionId === r.id}
