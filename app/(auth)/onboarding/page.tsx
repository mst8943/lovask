...
export default function OnboardingPage() {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-start sm:justify-center bg-[#09090b] relative overflow-hidden pt-12 pb-8 sm:py-12 px-4 sm:px-6">
            ...
            <div className="w-full max-w-3xl flex flex-col items-center gap-8 relative z-10">
                {/* Header branding */}
                <div className="flex items-center gap-3 self-center sm:self-start sm:absolute sm:top-[-4rem] sm:left-0 md:top-8 md:left-8">
                    ...
                    <span className="text-2xl font-bold text-white tracking-tight">Lovask</span>
                </div>
