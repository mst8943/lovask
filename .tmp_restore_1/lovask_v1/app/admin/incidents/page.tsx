        ...
        <div className="space-y-6">
            <div className="flex items-end justify-between">
                <div>
                    ...
                    <p className="text-sm text-gray-400">Olay yönetimi ve timeline</p>
                </div>
                    ...
                    <div key={row.id} className="glass-panel p-4 rounded-2xl space-y-2">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <div className="text-xs text-gray-400">{row.severity} · {row.status}</div>
                            </div>
                            <div className="flex items-center gap-2 text-xs">
                                <button onClick={() => loadEvents(row.id)} className="px-2 py-1 rounded-full border border-white/10 bg-white/10">Timeline</button>
                                {row.status !== 'closed' && (
                        ...
                        {row.notes && <div className="text-xs text-gray-300">{row.notes}</div>}
