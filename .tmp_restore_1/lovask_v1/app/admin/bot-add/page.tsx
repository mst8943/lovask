        ...
        <div className="space-y-6">
            <div className="flex items-end justify-between">
                <div>
                    ...
                    <p className="text-sm text-gray-400">Yeni bot oluştur ve yapılandır</p>
                </div>
            ...
            <div className="glass-panel p-5 rounded-2xl border border-white/10 space-y-4">
                <div className="text-xs uppercase tracking-[0.2em] text-gray-400">Form</div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <div className="space-y-1">
                        <div className="text-sm text-gray-300">Yaş</div>
                        <input
                            type="number"
                            value={form.age}
                    ...
                    <div className="space-y-1">
                        <div className="text-sm text-gray-300">Cinsiyet</div>
                        <input
                            value={form.gender}
                    ...
                    <div className="space-y-1">
                        <div className="text-sm text-gray-300">Şehir</div>
                        <input
                            value={form.city}
                    ...
                    <div className="space-y-1 md:col-span-2">
                        <div className="text-sm text-gray-300">Biyografi</div>
                        <input
                            value={form.bio}
                    ...
                    <div className="space-y-1 md:col-span-2">
                        <div className="text-sm text-gray-300">Foto URL (virgül ile)</div>
                        <input
                            value={form.photos}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="space-y-1">
                        <div className="text-sm text-gray-300">Bot Grubu</div>
                        <select
                            value={form.groupId}
                    ...
                    <div className="space-y-1">
                        ...
                        <input
                            ...
                            className="w-full px-3 py-2 bg-black/20 border border-white/10 rounded-lg"
                        />
                        <div className="text-[10px] text-gray-400">Saatleri UTC gir: 02:00, 08:00, 14:00</div>
                    </div>
                    <div className="space-y-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="space-y-1">
                        ...
                        <textarea
                            ...
                            className="w-full min-h-[100px] px-3 py-2 bg-black/20 border border-white/10 rounded-lg"
                        />
                    </div>
