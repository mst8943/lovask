    ...
    return (
        <div className="space-y-6">
            ...
            <h1 className="text-2xl font-bold">Bot Gruplari</h1>
                    <p className="text-sm text-gray-400">Grup bazli davranis ve zamanlama</p>
                </div>
            ...
            <div className="glass-panel p-5 rounded-2xl space-y-3 border border-white/10">
                <div className="text-xs uppercase tracking-[0.2em] text-gray-400">Yeni Grup</div>
                <div className="text-sm text-gray-300">Grup adı</div>
                <input
                    value={form.name}
                ...
                />
                <div className="text-sm text-gray-300">Grup prompt</div>
                <textarea
                    value={form.prompt}
                    onChange={(e) => setForm({ ...form, prompt: e.target.value })}
                    placeholder="Grup prompt"
                    className="w-full min-h-[80px] px-3 py-2 rounded-lg bg-black/20 border border-white/10"
                />
                <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                        <div className="text-sm text-gray-300">Ton</div>
                        <select
                            value={form.tone}
                    ...
                    <div className="space-y-1">
                        <div className="text-sm text-gray-300">Dil modu</div>
                        <select
                    ...
                    <div className="space-y-1">
                        <div className="text-sm text-gray-300">Oto-beğeni oranı (%)</div>
                        <input
                            type="number"
                    ...
                    <div className="space-y-1">
                        <div className="text-sm text-gray-300">Etkileşim yoğunluğu</div>
                        <select
                ...
                <div className="text-sm text-gray-300">Aktif saatler (UTC)</div>
                <input
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                        <div className="text-sm text-gray-300">Cooldown (saat)</div>
                        <input
                            type="number"
                    ...
                    <div className="space-y-1">
                        <div className="text-sm text-gray-300">Profil rotasyonu (dk)</div>
                        <input
                            type="number"
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                        <div className="text-sm text-gray-300">Cevap gecikmesi min (sn)</div>
                        <input
                            type="number"
                    ...
                    <div className="space-y-1">
                        <div className="text-sm text-gray-300">Cevap gecikmesi max (sn)</div>
                        <input
                            type="number"
                ...
                <button onClick={handleCreateGroup} className="w-full py-3 rounded-xl bg-white/10">
                    Grup Oluştur
                </button>
            </div>
    ...
    return (
        <div className="glass-panel p-4 rounded-2xl space-y-2 border border-white/10">
            <div className="flex items-center justify-between">
                ...
                <button onClick={() => setEditing(!editing)} className="text-xs px-2 py-1 rounded-full bg-white/10">
                    {editing ? 'Kapat' : 'D?zenle'}
                </button>
            </div>
            <div className="text-xs text-gray-400">{group.prompt?.slice(0, 80) || '?'}</div>
            {editing && (
                <div className="grid grid-cols-2 gap-2">
                    <div className="col-span-2 text-xs uppercase tracking-[0.2em] text-gray-400">Duzenle</div>
                    <div className="col-span-2 text-sm text-gray-300">Grup adı</div>
                    <input
                        value={state.name}
                    ...
                    <div className="col-span-2">
                        <div className="text-sm text-gray-300 mb-1">Grup prompt</div>
                        <textarea
                            value={state.prompt}
                    ...
                    <div className="col-span-2 flex items-center gap-3">
                        ...
                        <button onClick={save} className="ml-auto px-3 py-2 rounded-lg bg-white/10 text-xs">
                            Kaydet
                        </button>
                    </div>
                </div>
