                                ...
                                return (
                                    <div key={r.id} className="grid grid-cols-[1fr_1.4fr_1fr_0.8fr_1fr] gap-0 text-sm">
                                        ...
                                        <div className="px-4 py-3 text-xs">
                                            <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs border ${active ? 'bg-emerald-500/10 text-emerald-200 border-emerald-500/20' : 'bg-red-500/10 text-red-200 border-red-500/20'}`}>
