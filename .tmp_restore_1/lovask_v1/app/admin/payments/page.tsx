    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-sm text-gray-400">Kart ödeme talepleri</p>
            </div>
                ...
                <div className="space-y-3">
                    {rows
                        ...
                        <div key={r.id} className="glass-panel p-4 rounded-2xl">
                            ...
                            <div className="text-sm text-gray-300">{r.amount} {r.currency}</div>
                            <div className="text-xs text-gray-500 flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className="px-2 py-1 rounded-lg bg-white/10 text-[10px]"
                                >
