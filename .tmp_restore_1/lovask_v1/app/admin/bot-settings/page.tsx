    ...
    return (
        <div className="space-y-6">
            ...
            <h1 className="text-2xl font-bold">Bot Ayarlari</h1>
                    <p className="text-sm text-gray-400">Global davranis ve zamanlama</p>
                </div>
            ...
            <div className="glass-panel p-5 rounded-2xl space-y-4 border border-white/10">
                <div className="text-xs uppercase tracking-[0.2em] text-gray-400">Genel</div>
                <div className="text-sm text-gray-300">Global prompt</div>
                <textarea
                    value={settings.global_prompt}
                    onChange={(e) => setSettings({ ...settings, global_prompt: e.target.value })}
                    placeholder="Global promptu"
                    className="w-full min-h-[120px] px-3 py-2 rounded-lg bg-black/20 border border-white/10"
                />
                ...
                <div className="text-sm text-gray-300">Görüldü sonrası cevap gecikmesi (sn)</div>
                <input
                    type="number"
