...
export default function AdminBotsPage() {
    ...
    const parseActiveHours = (raw: string) => raw
        .split(',')
        .map((v) => v.trim())
        .filter(Boolean)
        .map((v) => v.replace(':00', ''))
        ...
        try {
            const res = await fetch('/api/admin/bots/create', {
                ...
                body: JSON.stringify({
                    ...
                    active_hours: parseActiveHours(form.activeHoursRaw || ''),
        ...
        try {
            ...
            const res = await fetch('/api/admin/bots/auto-create', {
                ...
                body: JSON.stringify({
                    ...
                    active_hours: parseActiveHours(autoActiveHoursRaw || ''),
                }),
            })
            if (!res.ok) throw new Error(await res.text())
            await load()
    ...
    return (
        <div className="space-y-6">
            ...
            <div id="bot-create" className="glass-panel p-5 rounded-2xl border border-white/10 space-y-3">
                <div className="text-xs uppercase tracking-[0.2em] text-slate-600">Sayfa İçeriği</div>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-xs">
                    <a className="px-3 py-2 rounded-lg bg-white/5 border border-white/10" href="#bot-create">Bot Oluştur</a>
                    <a className="px-3 py-2 rounded-lg bg-white/5 border border-white/10" href="#bot-auto">Otomatik Toplu Bot</a>
                    <a className="px-3 py-2 rounded-lg bg-white/5 border border-white/10" href="#name-pool">İsim Havuzu</a>
                    <a className="px-3 py-2 rounded-lg bg-white/5 border border-white/10" href="#bulk-import">Toplu İçe Aktar</a>
                    <a className="px-3 py-2 rounded-lg bg-white/5 border border-white/10" href="#media-pool">Foto/Bio Havuzu</a>
                    <a className="px-3 py-2 rounded-lg bg-white/5 border border-white/10" href="#bulk-group">Toplu Grup Ata</a>
                    <a className="px-3 py-2 rounded-lg bg-white/5 border border-white/10" href="#bot-list">Bot Listesi</a>
                </div>
            </div>
            {error && (
            ...
            <div id="bot-auto" className="glass-panel p-5 rounded-2xl border border-white/10 space-y-3">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <button onClick={() => setGroupOpen(true)} className="text-xs px-3 py-1.5 rounded-full bg-white/10 border border-white/10 text-gray-300">
                            Yeni Grup
                        </button>
                        <button onClick={runMaintenance} className="text-xs px-3 py-1.5 rounded-full bg-white/10 border border-white/10 text-gray-300">
                            Bakım Çalıştır
                        </button>
                    </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="space-y-1">
                        ...
                        <input
                            ...
                            placeholder="ad"
                            className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-xl text-sm text-slate-700 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-white/10 focus:border-white/30"
                        />
                    </div>
                    <div className="space-y-1">
                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="space-y-1">
                        <div className="text-sm text-slate-700">Aktif saatler (UTC)</div>
                        <input
                ...
                <textarea
                    ...
                    className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-xl text-sm text-slate-700 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-white/10 focus:border-white/30 min-h-[90px]"
                />
            ...
            <div className="glass-panel p-5 rounded-2xl border border-white/10 space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <div className="space-y-1">
                        <div className="text-sm text-slate-700">Kadın yuzdesi</div>
                        <input
                            type="number"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="text-xs text-gray-500">Rastgele modda şehir listesi kullanılır.</div>
                    </div>
                </div>
                <div className="flex flex-wrap gap-4">
                    <label className="text-xs flex items-center gap-2">
            ...
            <div id="name-pool" className="glass-panel p-5 rounded-2xl border border-white/10 space-y-3">
                <h2 className="font-semibold">İsim Havuzu</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="space-y-1">
                        <div className="text-sm text-slate-700">Kadın isimleri (her satir bir isim)</div>
                        <textarea
                            value={nameFemale}
                            onChange={(e) => setNameFemale(e.target.value)}
                            className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-xl text-sm text-slate-700 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-white/10 focus:border-white/30 min-h-[140px]"
                        />
                    </div>
                    <div className="space-y-1">
            ...
            <div id="bulk-import" className="glass-panel p-5 rounded-2xl border border-white/10 space-y-3">
                ...
                <textarea
                    ...
                    className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-xl text-sm text-slate-700 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-white/10 focus:border-white/30 min-h-[120px]"
                />
            ...
            <div id="media-pool" className="glass-panel p-5 rounded-2xl border border-white/10 space-y-3">
                <h2 className="font-semibold">Bot Foto/Bio Havuzu</h2>
                <input
                    type="file"
                    accept=".zip"
                    onChange={(e) => handlePoolZip(e.target.files?.[0] || null)}
                    className="px-3 py-2 bg-white/5 border border-white/10 rounded-xl text-sm text-slate-700 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-white/10 focus:border-white/30"
                />
                <div className="text-xs text-slate-600">
                ...
                <div className="grid grid-cols-1 md:grid-cols-[140px_1fr] gap-3">
                    ...
                    <textarea
                        ...
                        className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-xl text-sm text-slate-700 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-white/10 focus:border-white/30 min-h-[80px]"
                    />
                </div>
            ...
            <div id="bulk-group" className="glass-panel p-5 rounded-2xl border border-white/10 space-y-3">
            ...
            {groupOpen && (
                <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4">
                    <div className="glass-panel w-full max-w-lg p-5 rounded-2xl space-y-4 border border-white/10">
                        <div className="flex items-center justify-between">
                            <div>
                        <h2 className="text-lg font-semibold">Yeni Bot Grubu</h2>
                                <div className="text-xs text-slate-600">Botları kategoriye ayır</div>
                            </div>
                            <button onClick={() => setGroupOpen(false)} className="px-3 py-1 rounded-full bg-white/10 text-xs">
                                Kapat
                            </button>
                        </div>
                        <input
    ...
    return (
        <div className="glass-panel p-4 rounded-2xl border border-white/10 space-y-3">
            <div className="flex items-start justify-between gap-4">
                <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] border ${isOnline ? 'bg-emerald-50 text-emerald-700 border-emerald-200' : 'bg-slate-50 text-slate-500 border-slate-200'}`}>
                            ...
                            {isOnline ? 'Çevrim içi' : 'Çevrimdışı'}
                        </span>
                        <button
                            type="button"
                            onClick={() => setExpanded(true)}
                            className="text-[11px] uppercase tracking-[0.18em] text-slate-600 px-2 py-1 rounded-full border border-white/10 bg-white/5"
                        >
                            Hızlı Düzenle
                        </button>
                    </div>
                ...
                <div className="flex items-center gap-2">
                    <button onClick={toggleActive} className="text-xs px-2.5 py-1.5 rounded-full bg-white/10 border border-white/10">
                        {bot.bot_configs?.behavior_settings?.active === false ? 'Pasif' : 'Aktif'}
                    </button>
                    <button onClick={toggleUseGlobal} className="text-xs px-2.5 py-1.5 rounded-full bg-white/10 border border-white/10">
                        {bot.bot_configs?.use_global === false ? 'Özel' : 'Global'}
                    </button>
                </div>
            </div>
            <div className="text-xs text-slate-600 bg-white/5 border border-white/10 rounded-lg px-3 py-2">
                Prompt: {bot.bot_configs?.personality_prompt?.slice(0, 80) || '—'}
            </div>
            <div className="flex items-center gap-2">
                <button onClick={loadStats} className="text-xs px-2.5 py-1.5 rounded-full bg-white/10 border border-white/10">
            ...
            <div className="grid grid-cols-2 gap-2">
                <div className="space-y-1">
                    ...
                    <input
                        ...
                        className="bg-white/5 border border-white/10 rounded-xl text-sm text-slate-700 placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-white/10 focus:border-white/30 px-3 py-2"
                        placeholder="Örn: 5"
                    />
                </div>
                <div className="space-y-1">
            ...
            {expanded && (
                <div className="mt-3 border-t border-white/10 pt-3 space-y-3">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                        ...
                        <div className="space-y-1 md:col-span-2">
                            ...
                            <textarea
                                ...
                                placeholder="Biyografi"
                                className="w-full px-3 py-2 rounded-lg bg-black/20 border border-white/10 min-h-[80px]"
                            />
                        </div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    ...
                    <textarea
                        ...
                        placeholder="Bot Özel prompt"
                        className="w-full px-3 py-2 rounded-lg bg-black/20 border border-white/10 min-h-[90px]"
                    />
                    <button
                        onClick={async () => {
                            setSaving(true)
