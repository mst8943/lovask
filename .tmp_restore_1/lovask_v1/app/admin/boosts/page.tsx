                            ...
                            return (
                                <div key={r.id} className="grid grid-cols-[1.2fr_1fr_1fr_1fr_0.8fr] gap-0 text-sm">
                                    ...
                                    <div className="px-4 py-3 text-xs">
                                        <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs border ${active ? 'bg-emerald-500/10 text-emerald-200 border-emerald-500/20' : 'bg-white/10 text-gray-300 border-white/10'}`}>
                                            {active ? 'Aktif' : 'Bitti'}
                                        </span>
                                    </div>
                                </div>
